...
export default function pricing() {
  ...
  return (
    ...
    <div style={{height:"400px",width:"1100px",display:"flex",marginTop:"120px",position:"relative"}}>{images.map((id)=>
        ...
        <label style={{borderRadius:"9px",backgroundColor:"rgb(223,230,107)",height:"60px",width:"120px",position:"absolute",marginLeft:"280px",paddingTop:"10px",marginTop:"-20px",paddingLeft:"37px",fontSize:"30px",color:"red"}}>{id.dis}</label>
      <img  style={{height:"500px",width:"300px",
    borderRadius:"20px",marginLeft:"200px"}} src={id.src}/>
    <label style={{borderRadius:"9px",backgroundColor:" rgb(230,109,107)",height:"60px",width:"120px",position:"absolute",marginLeft:"280px",paddingTop:"10px",marginTop:"-20px",paddingLeft:"7px",fontSize:"30px",color:"white"}}>Rs.{id.price}</label>
      </div>
          )}</div>
          </div>
  )
