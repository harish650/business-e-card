  ...
  return (<>
    <div className='wholecontent'>
       <div className='content'>
           ...
           <img className='profileimage' src={prof}/>
               ...
               <h4 className='name'>Jindal South West</h4>
               </div>
         ...
         <div style={{display:"flex",marginTop:"20px",marginLeft:"30px"}}>
               <img className='detailsicons'  src={calltemp}/>
                <h4 style={{fontSize:"21px",fontWeight:"lighter",marginLeft:"30px"}}>1800-225-225</h4></div>

                <div style={{display:"flex",marginTop:"20px",marginLeft:"30px"}}> <img className='detailsicons' src={emailtemp}/>
                <h4 style={{fontSize:"21px",marginLeft:"30px"}}>support.steel@jsw.in</h4></div>
                ...
                <h4 style={{fontSize:"21px",marginLeft:"30px"}}>JSW Centre Bandra (East) Bandra Kurla Complex Mumbai - India</h4></div>
               </div>
          ...
          <p className='branch1'>-- Bandra Kurla Complex
                                 Mumbai - 400051
                                 Maharashtra.</p>
    ...
    <img className='galicon' src={gal3}/><h1></h1>
        ...
        <div className='payment'>
            ...
            <div style={{display:"flex"}}>  <img className='payicon' src={gapay}/><h3 className='no'> - 9034457844</h3></div>
            <div style={{display:"flex"}}><img className='payicon'src={phoneay}/><h3 className='no'>- 2354656</h3></div>
            <div style={{display:"flex"}}> <img className='payicon'src={payment}/><h3 className='no'>- 35452345</h3></div>
            <div style={{display:"flex"}}> <img className='payicon'src={netbank}/><h3 className='no'>- Net-Banking</h3></div>
            <div style={{display:"flex"}}> <img className='payicon'src={creditcard}/><h3 className='no'>- credit-card</h3></div>
                 <div style={{display:"flex"}}><img className='payicon'src={debitcard}/><h3 className='no'>- debit-card</h3></div>
