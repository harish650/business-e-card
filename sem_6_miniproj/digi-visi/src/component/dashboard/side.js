...
export default function side() {
  return (
    ...
    <a  className='sidea' icon={<img  style={{height:"40px",width:"40px",backgroundColor:"white"}}src={file}/>}>HOME</a>
    <a className='sidea' href="/createcard" icon={<img  style={{height:"40px",width:"40px",background:"white"}}src={file}/>}>Create Card</a>
    <a className='sidea'icon={<img  style={{height:"40px",width:"40px",background:"white"}}src={file}/>}>Edit Card</a>
