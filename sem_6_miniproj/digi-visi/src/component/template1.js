  ...
  return (
    <div className="template1_bacgr">
      <div className="template1_pos">
        ...
        <div>
          ...
          <div>
            ...
            <h1 className="template1_add">16,Marappan Street-1</h1>
            <h1 className="template1_add1">Nall Road,Erode,638001</h1>
          </div>
      ...
      <h1 style={{fontSize: "13px",
              marginLeft: "620px",
              fontFamily: " Arial, Helvetica, sansserif",
              fontWeight: "100",marginTop: "-230px",}}>www.webasetech.in</h1></div>
      </div> 
  );
}